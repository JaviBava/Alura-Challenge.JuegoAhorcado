        ...
        if (regex.test(key)) {
            ...
            if (estaEnPalabra(letra, secreto)) {
                if (!letrasCorrectas.includes(letra)) {
                    ...
                    advertir(letra + " ya fue agregada", "lightgreen");
                }
            }else{
...
const verificarFinJuego = (secreto, letrasCorrectas, errores) => {
    if (errores.length == 6) {
        escribirTexto("PERDISTE", "lightcoral");
